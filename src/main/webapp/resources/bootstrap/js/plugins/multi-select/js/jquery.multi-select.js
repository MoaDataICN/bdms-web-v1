    ...
    init: function(){
      ...
      if (ms.next('.ms-container').length === 0){
        ...
        that.$selectableUl.on(action, '.ms-elem-selectable', function(){
        	var wid = ($(this).parents("[id*=widget]")).attr("data-gs-wid");
        	if(wid == 1){
        		var selectMax = 9;
				if ( ms.find('option:selected').length + 1 > selectMax) {
					//console.log("최대 선택 가능한 갯수는 " + selectMax + "입니다.");
					alert("최대 선택 가능한 갯수는 " + selectMax + "입니다."); //jquery alert 사용시 select창 닫힘
