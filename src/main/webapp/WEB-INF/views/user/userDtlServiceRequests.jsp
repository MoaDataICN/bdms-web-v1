...
<div class="alerts-wrap mt-30px">
    ...
    <div class="mt-16px table-data-wrap">
        ...
        <p class="title-status mr-12px">-<span class="bold-t-01" id="serviceRequests_cntTotal"></span>
        <span id="desc_all" class="hidden-desc"><spring:message code="serviceRequestsTap.description.all"/></span>
        <span id="desc_last24" class="hidden-desc" style="display:none;"><spring:message code="serviceRequestsTap.description.last24"/></span>
        </p>
    </div>
