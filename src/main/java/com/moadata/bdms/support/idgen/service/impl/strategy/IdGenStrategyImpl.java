 ...
 * limitations under the License.
 */
package com.moadata.bdms.support.idgen.service.impl.strategy;
 ...
 * </pre>
 */
public class IdGenStrategyImpl implements IdGenStrategy {
     ...
     *        fillChar
     */
    public IdGenStrategyImpl(String prefix, int cipers, char fillChar) {
        super();
        this.prefix = prefix;
        this.cipers = cipers;
        this.fillChar = fillChar;
