    ...
    public boolean insertCheckupDataList(CheckupVO checkupVO){
        ...
        if(tempList.size() > 0) {
            for(int i=0; i< tempList.size(); i ++) {
                ...
                try {
                    if (!tempList.get(i).get("hght").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("wght").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("wst").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("sbp").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("dbp").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("fbs").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("hba1c").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("tc").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("hdl").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("ldl").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("trgly").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("sc").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("gfr").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("acd").equals("")) {
                        tmpmap = new HashMap<>();
                        tmpmap.put("metaDataCode", "24000000");  //14
                        tmpmap.put("msmt", tempList.get(i).get("acd"));
                        checkUpList.add(tmpmap);
                    }

                    if (!tempList.get(i).get("bun").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("alt").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("ast").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("gtp").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("tprtn").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (!tempList.get(i).get("blrbn").equals("")) {
                        tmpmap = new HashMap<>();
                    ...
                    if (((String)tempList.get(i).get("locale")).indexOf("ko") != -1) {
                    ...
                    for (int k = 0; k < checkUpList.size(); k++) {
                        ...
                        checkUpList.get(k).put("usrId", tempList.get(i).get("userId"));
                    }

                    tempList.get(i).put("reportId", reportId);
                    // 입력창 필드 해결 이후 추가 예정

                    String brthDtStr = (String)checkUpList.get(i).get("brthDt");
